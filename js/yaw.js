...
(function($yawJq, window) {
  ...
  return Yaw = (function() {
    ...
    Yaw.prototype.activatePage = function(index) {
      ...
      $yawJq('.yaw__feedback__pager').find('li').eq(index - 1).find('a').addClass('active').closest('li').siblings().find('a').removeClass('active');
